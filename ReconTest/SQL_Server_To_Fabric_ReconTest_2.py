...
class ReportGenerator:
    ...
    def generate_html_report(self, results: List[ValidationResult], output_path: str = None) -> str:
        """Generate HTML validation report"""
        if not output_path:
            output_path = f"validation_report_{self.report_timestamp}.html"
    ...
    def generate_json_report(self, results: List[ValidationResult], output_path: str = None) -> str:
        """Generate JSON validation report"""
        if not output_path:
            output_path = f"validation_report_{self.report_timestamp}.json"
    ...
    def _result_to_dict(self, result: ValidationResult) -> Dict:
        ...
        return {
            ...
            'sql_server_count': result.sql_server_count,
            'fabric_count': result.fabric_count,
            'execution_time_sql': result.execution_time_sql,
            'execution_time_fabric': result.execution_time_fabric,
            'data_hash_sql': result.data_hash_sql,
            'data_hash_fabric': result.data_hash_fabric,
            'differences_count': len(result.differences_found),
            'differences': result.differences_found,
