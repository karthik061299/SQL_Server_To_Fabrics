    ...
    def generate_report(self):
        ...
        report = {
            "summary": {
                ...
                "total_execution_time_seconds": self.end_time - self.start_time if self.end_time and self.start_time else 0,
                "total_sql_server_time": total_sql_server_time,
                "total_fabric_time": total_fabric_time,
                "average_performance_difference_percent": avg_performance_diff
            },
            "test_results": []
        }